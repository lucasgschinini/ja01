 ...
 * 10/09/2014
 */
public class ResultadoBusquedaTransferenciaSinConciliarMapeador extends MapeadorResultadoBusqueda {
	...
	public DTO map(VistaSoporteResultadoBusqueda vo) throws NegocioExcepcion {
		...
		TransferenciaDto registroAvcSinConciliarDto = new TransferenciaDto();
		...
		if(vista != null){			
			...
			if(vista.getCuitFormateado() != null){	
				registroAvcSinConciliarDto.setCuit(vista.getCuitFormateado());
			}
			...
			if(vista.getObservacion() != null){	
				registroAvcSinConciliarDto.setObservacion(vista.getObservacion());
			}
			...
			if(vista.getErrorAltaInterdeposito() != null){	
				registroAvcSinConciliarDto.setErrorAltaInterdeposito(vista.getErrorAltaInterdeposito());
			}
			if(vista.getFechaErrorFormateado() != null){	
				registroAvcSinConciliarDto.setFechaErrorFormateado(vista.getFechaErrorFormateado());
			}
			//usuarios de LDAP
