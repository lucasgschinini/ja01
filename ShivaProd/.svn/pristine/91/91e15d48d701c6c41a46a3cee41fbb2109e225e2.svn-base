...
export LOG_FILE=actualizarIdConstanciasRecepcionValoresMigrados.salida.$FECHA_HORA.log
export SQL_FILE=actualizarIdConstanciasRecepcionValoresMigrados.sql
...
${ORACLE_HOME}/bin/sqlplus -L $USRTOT/$PASSWORD@$DB_INSTANCE @$SQL_FILE >> $LOG_FILE
