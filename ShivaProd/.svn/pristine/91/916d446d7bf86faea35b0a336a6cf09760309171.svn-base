...
import ar.com.telecom.shiva.presentacion.wsdl.sap.r3.consultaProveedores.ZFISHIVAVENDORFINDWS;
import ar.com.telecom.shiva.presentacion.wsdl.sap.r3.consultaProveedores.ZFISSH001;
import ar.com.telecom.shiva.presentacion.wsdl.sap.r3.consultaProveedores.ZFISSH001I;
import ar.com.telecom.shiva.presentacion.wsdl.sap.r3.consultaProveedores.ZFITTSH001;
import ar.com.telecom.shiva.presentacion.wsdl.sap.r3.consultaProveedores.ZFITTSH001I;
import ar.com.telecom.shiva.presentacion.wsdl.sap.r3.consultaProveedores.ZSRETURN;
import ar.com.telecom.shiva.presentacion.wsdl.sap.r3.consultaProveedores.ZTTRETURN;

public class SapR3ConsultaProveedoresWS extends SapConsultasWS {
	
	private final String CABECERA_MENSAJE_SERVICIO_WS = "WS SapConsultaProveedores";
	
	@Autowired
	ZFISHIVAVENDORFINDWS webServiceSapR3ConsultaProveedoresClient;
	...
	public SalidaSapConsultaProveedoresWS consultarProveedores(EntradaSapConsultaProveedoresWS entrada) throws NegocioExcepcion {
		Traza.auditoria(getClass(), "Se usa el WebService de S3");
		...
		try {
	    	...
	    	String contenedorEntradaIdSociedad = SAP_WS_CODIGO_SOCIEDAD_TELECOM_ARGENTINA_S4;
	 		...
	 		webServiceSapR3ConsultaProveedoresClient.zfiSHIVAVENDORFIND(contenedorEntradaCuits, 
