				...
				<div id="inside">
					...
					<div id="payments" class="box">
						...
						<div class="pagos_anticipos" style="margin-top: 160px; margin-bottom: 160px;">
							<div align="center">
								<p><strong><c:out value="${mensaje}"/></strong></p>
							</div>
							<div align="center">
							...
							<form id=primeraParteFormulario method="post" action="${pageContext.request.contextPath}/${url}">		
								<div class="row" style="margin-top: 20px; margin-bottom: 30px; margin-right: 2px">
									<div align="center">
										<button class="btn btn-primary btn-small" id="aceptar" name= "aceptar" >
										<i class="icon-white icon-ok"></i>    <spring:message code="actualizacionOK.boton.aceptar"/>
										</button>									
									</div>
								</div>
								...
								<input type="hidden" id="idEmpresa" name="idEmpresa" value="${empresaModel}" />
								<input type="hidden" id="idSegmento" name="idSegmento" value="${segmentoModel}" />
							</form>
