...
export LOG_FILE=actualizarReciboPreimpresoMigracion.salida.$FECHA_HORA.log
export SQL_FILE=actualizarReciboPreimpresoMigracion.sql
...
${ORACLE_HOME}/bin/sqlplus -s -L $USRTOT/$PASSWORD@$DB_INSTANCE @$SQL_FILE >> $LOG_FILE
