...
NOMBRE_PROCESO=batch-shiva-reporteTareasPendientesAplicacionManual
	...
	then
		...
		java -cp ".:${CLASSPATH}" -Djava.io.tmpdir=${TEMP} \
			...
			-Xms1303m -Xmx1303m -XX:MaxPermSize=256m \
	   		ar.com.telecom.shiva.batch.ReporteTareasPendientesAplicacionManualBatchRunner $1 >>$LOG_ERROR >>$LOG_ARCHIVO 2>>$LOG_ERROR
	else
