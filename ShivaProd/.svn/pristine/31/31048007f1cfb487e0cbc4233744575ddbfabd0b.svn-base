...
@XmlType(name = "impuestoMunSegHig", propOrder = {"idValor","importe","saldoDisponible","fechaValor","motivo","operacionAsociada",
						"observaciones","cliente","numeroConstancia","fechaEmision"})
public class ValoresImpuestoSeguridadHigienge  {
