...
@Entity
@Table(name = "SHV_MIG_VALOR_CHEQUE_DIFERIDO")
public class ShvMigValorChequeDiferido extends Modelo {

	private static final long serialVersionUID = 1L;
	
	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SEQ_SHV_MIG_VALOR_CHEQUE_DIF")
    @SequenceGenerator(name="SEQ_SHV_MIG_VALOR_CHEQUE_DIF", sequenceName="SEQ_SHV_MIG_VALOR_CHEQUE_DIF",allocationSize=1)
	@Column(name="ID")
	private Long idValorChequeDiferido;
	...
	/**
	 * @return the idValorChequeDiferido
	 */
	public Long getIdValorChequeDiferido() {
		return idValorChequeDiferido;
	}
	/**
	 * @param idValorChequeDiferido the idValorChequeDiferido to set
	 */
	public void setIdValorChequeDiferido(Long idValorChequeDiferido) {
		this.idValorChequeDiferido = idValorChequeDiferido;
	}
	/**
