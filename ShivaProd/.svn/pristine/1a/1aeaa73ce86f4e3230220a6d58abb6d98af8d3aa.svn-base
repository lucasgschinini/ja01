...
NOMBRE_PROCESO=batch-shiva-reconfirmacionCobros
...
######################### Ejecucion ###########################
echo Id Cobro a reconfirmar: $1 >>$LOG_ARCHIVO
	...
	java -cp ".:${CLASSPATH}" -Djava.io.tmpdir=${TEMP} \
		-Djavax.net.ssl.trustStore=${JAVA_HOME}/jre/lib/security/cacerts \
	 	-Dentorno=${ENTORNO} -Dconfiguracion=${SHIVA_CONFIG} -DnombreLog=${NOMBRE_PROCESO} \
   		ar.com.telecom.shiva.batch.ReconfirmacionCobrosBatchRunner $1 >>$LOG_ERROR >>$LOG_ARCHIVO 2>>$LOG_ERROR
else
