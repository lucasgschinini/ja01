...
<c:choose>
	<c:when test="${esPantallaDetalle}">
			<spring:message code="cobro.detalleCobro.title" />
	</c:when>
	<c:otherwise>
			<spring:message code="cobro.AprobacionCobro.title" />
	</c:otherwise>
</c:choose>
</title>
...
<script src="${pageContext.request.contextPath}/js/shiva-detalle-aprob-cobro.js"></script>
				...
				<div id="content">
					<div id="inside">
						<div id="payments" class="box">
							<c:choose>
								<c:when test="${esPantallaDetalle}">
										<div class="title" id="titleDetalle"><spring:message code="cobro.detalleCobro.title"/></div>
								</c:when>
								<c:otherwise>
										<div class="title" id="titleAprobacion"><spring:message code="cobro.AprobacionCobro.title"/></div>
								</c:otherwise>
							</c:choose>							
							<div class="pagos_anticipos">
							<form:form id="formCobro" commandName="cobroDto"
 								action="${pageContext.request.contextPath}/cobro-detalle-aprobacion"> 
								...
								<input type="hidden" id="volver" name="volver" value="/cobro-detalle-aprobacion" />
								...
								<input type="hidden" id="monedaOperacion" name="monedaOperacion" value="${monedaOperacion}" />
									...
									<div class="row">
										<div class="span3">
											<label class="control-label" for="prevAnalista"><spring:message code="cobro.detalleCobro.idOperacionCobro" /></label>
											<div class="controls">
										...
										<div class="span6" align="right" style="margin-top: 17px">
											<c:if test="${idOperacionMasiva != null}">
												...
												<spring:message code="cobro.detalleCobro.operacionMasiva.button" /></button>
											</c:if>
												<button type="button" align="right" class="btn btn-primary btn-small" id="btnHistorial" onclick="javascript:historialCobro();">
												<i class="icon-white icon-list-alt bigger-120"></i><spring:message code="cobro.detalleCobro.historialCobro.button" />
												</button>
												<button type="button" align="right" class="btn btn-primary btn-small" id="btnExportar" onclick="javascript:exportarDetalle();">
												<i class="icon-white icon-download-alt"></i> <spring:message code="cobro.detalleCobro.exportCobroExcel.button" />
												</button>
...
<%-- 															</c:forEach> --%>
										...
										<p style="padding: 25px 0px 5px 0px;"> <strong><spring:message code="cobro.detalleCobro.tratamientoDiferencia" /></strong></p>
										<div id="tratamientoDeDiferencia">
											<div class="row" style="padding-top: 8px;">
												...
												<div class="span3">
													<div class="bloqueReintegro">
														<div id="tramReint">
															<label class="control-label" id="labeltramReintInput" for="tramReintInput">Trámite de reintegro</label> <input id="tramReintInput" name="tramReintInput" value="${tramReintInput}"
												...
												<div class="span3">
													<div class="bloqueReintegro">
														<div id="fechaAltaTramReintOpc">
															<label class="control-label" id="labelfechaAltaTramReint" for="fechaAltaTramReint">Fecha alta trámite de reintegro:</label> <input id="fechaAltaTramReint"
																value="${fechaAltaTramReint}" name="fechaAltaTramReint" class="span3" type="text" data-date-format="dd/mm/yyyy" data-date-language='es' disabled>
														</div>
													</div>
												</div>
											</div>
											<div class="row">
												...
												<div class="span3">
													<div class="bloqueSistemaDestino">
														<label class="control-label" id="labelLinea" for="lineaInput">Línea</label> <input id="lineaInput" name="lineaInput" value="${lineaInput}"
															maxlength="10" type="text" class="input" disabled />
													</div>
												</div>
												<div class="span3">
													<div class="bloqueSistemaDestino">
														<label class="control-label" id="labelAcuerdo" for="acuerdoFactInput">Acuerdo de facturación</label> <input id="acuerdoFactInput" name="acuerdoFactInput"
															value="${acuerdoFactInput}" maxlength="10" type="text" class="input" disabled />
														<input type="hidden" id="estadoAcuerdoFacturacion" name="estadoAcuerdoFacturacion" value="${estadoAcuerdoFacturacion}" />
													</div>
												</div>
												<div class="span6">
													<div id="bloqueReferencia" >
														<label class="control-label"  id="labelReferencia" for="codigoOperacionText"><spring:message
										...
										<div id="bloqueAplicacionManual">
										<p style="padding: 25px 0px 5px 0px;"><strong><spring:message code="cobro.detalleCobro.listado.comprobantes.operacion.externa"/></strong></p>
											<br>
											<div class="row">
											<div class="span9">
												<table id="prevComprobanteApliManual" class="tablaResultado" width="100%">
													<thead>
														<tr>
															<th></th>
															<th>Nombre</th>
										...
										<p style="padding: 25px 0px 5px 0px;"><strong><spring:message code="cobro.detalleCobro.listado.codigo.operacion.externa"/></strong></p>
								...
								<div class="row" style="margin-top: 17px">
									<div class="span9" align="right">
										<button class="btn btn-primary btn-small" id="btnAceptar" name="btnAceptar" type="button" onclick="javascript:autorizarAprobarCobro();">
											<i class="icon-white icon-ok"></i>&nbsp;&nbsp;Aceptar&nbsp;&nbsp;
										</button>
										<button type="button" class="btn btn-primary btn-small" id="btnRechazar" onclick="javascript:rechazarAprobacionCobro();">
