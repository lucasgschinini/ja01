...
Begin
  ...
  execute immediate 'grant select on '||'&1'||'.SHV_MAS_OPER_MASIV_BUSQUEDA'||' to '||'&2';
  dbms_output.put_line('Se ha creado exitosamente el grant al usuario '||'&2'||' para el objeto '||'&1'||'SHV_MAS_OPER_MASIV_BUSQUEDA');
