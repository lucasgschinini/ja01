 ...
 */
@Entity
@Table(name = "SHV_COB_MED_PAG_COMP_CES_CRED")
@PrimaryKeyJoinColumn(name="ID_MEDIO_PAGO")
public class ShvCobMedioPagoCompensacionCesionCredito extends ShvCobMedioPagoUsuario {
	...
	public ShvCobMedioPagoCompensacionCesionCredito() {
