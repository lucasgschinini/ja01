...
@XmlType(name = "impuestoTasaMunicipal", propOrder = {"idValor","importe","saldoDisponible","fechaValor","motivo","operacionAsociada",
						"observaciones","cliente","numeroConstancia","fechaEmision"})
public class ValoresImpuestoTasaMunicipal {
