...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" class="busquedaResultado '+classes.sFilterInput+'"/>';
...
//		
//		DROMERO: SE COMENTA ESTA PARTE por problemas en IE8 
//               PROBAR Y SI HAY ALGUN ERROR DAR VUELTA ATRAS
