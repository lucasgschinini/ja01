...
<div id="container">
						...
						<div class="pagos_anticipos" style="margin-top: 160px; margin-bottom: 160px;">
							...
							<form id=primeraParteFormulario>		
								<div class="row" style="margin-top: 20px; margin-bottom: 30px; margin-right: 2px">
									<div align="center">
										<button class="btn btn-primary btn-small" id="btnAceptar" type="submit" onclick="javascript:procesarAlta();">
	...
	<script>
		function procesarAlta() {
			...
			$('#primeraParteFormulario')[0].action="${pageContext.request.contextPath}/procesar-alta-aviso-de-pago";
			$('#primeraParteFormulario')[0].submit();
		}
