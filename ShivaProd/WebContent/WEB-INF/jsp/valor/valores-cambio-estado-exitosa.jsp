...
<div id="container">
						...
						<div class="pagos_anticipos" style="margin-top: 160px; margin-bottom: 160px;">
							...
							<form id=primeraParteFormulario>		
								<div class="row" style="margin-top: 20px; margin-bottom: 30px; margin-right: 2px">
									<div align="center">
										<button class="btn btn-primary btn-small" id="aceptar" name= "aceptar" type="submit" >
	...
	<script>
		$('#aceptar').click(function() {
			...
			document.getElementById("primeraParteFormulario").action="${pageContext.request.contextPath}/vuelta-busqueda-cambioestado";
		});
	</script>
</body>
</html>