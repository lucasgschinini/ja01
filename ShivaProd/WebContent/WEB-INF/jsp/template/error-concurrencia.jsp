				...
				<div id="inside">
					...
					<div id="payments" class="box">
						...
						<div class="pagos_anticipos" style="margin-top: 160px; margin-bottom: 160px;">
							<div align="center">
								<div class="alert alert-error" style="width: 200px;text-align: left;">
								
									<c:if test="${not lista}">
										<a class="close" data-dismiss="alert">×</a><strong><spring:message code="error.error"/></strong><br/><spring:message code="error.concurrencia"/>
									</c:if>
									<c:if test="${lista}">
										<a class="close" data-dismiss="alert">×</a><strong><spring:message code="error.error"/></strong><br/>${mensaje}
									</c:if>
								</div>
							</div>
						
							<form id=primeraParteFormulario action="${pageContext.request.contextPath}/${url}">		
								<div class="row" style="margin-top: 20px; margin-bottom: 30px; margin-right: 2px">
									<div align="center">
										<button class="btn btn-primary btn-small" id="btnVolver" type="submit">
