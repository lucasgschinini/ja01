...
@Entity
@Table(name = "SHV_MIG_BOLETA_DEPOSITO_CHEQUE")
public class ShvMigBoletaDepositoCheque extends Modelo {

	private static final long serialVersionUID = 1L;
	
	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SEQ_SHV_MIG_BOLETA_DEPOSITO_CHEQUE")
    @SequenceGenerator(name="SEQ_SHV_MIG_BOLETA_DEPOSITO_CHEQUE", sequenceName="SEQ_SHV_MIG_BOLETA_DEPOSITO_CHEQUE",allocationSize=1)
	@Column(name="ID")
	private Long idBoletaDepositoCheque;
	...
	/**
	 * @return the idBoletaDepositoCheque
	 */
	public Long getIdBoletaDepositoCheque() {
		return idBoletaDepositoCheque;
	}
	/**
	 * @param idBoletaDepositoCheque the idBoletaDepositoCheque to set
	 */
	public void setIdBoletaDepositoCheque(Long idBoletaDepositoCheque) {
		this.idBoletaDepositoCheque = idBoletaDepositoCheque;
	}
	/**
