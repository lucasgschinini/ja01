...
@Entity
@Table(name = "SHV_MIG_BOLETA_DEP_CHEQUE_PD")
public class ShvMigBoletaDepositoChequeDiferido extends Modelo {

	private static final long serialVersionUID = 1L;
	
	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SEQ_SHV_MIG_BOLETA_DEP_CHEQUE_PD")
    @SequenceGenerator(name="SEQ_SHV_MIG_BOLETA_DEP_CHEQUE_PD", sequenceName="SEQ_SHV_MIG_BOLETA_DEP_CHEQUE_PD",allocationSize=1)

	@Column(name="ID")
	private Long idBoletaDepositoChequeDiferido;
	...
	private Long idReciboPreimpreso;
	@Column(name="NRO_CONSTANCIA_RECEPCION")	
	private Long nroConstanciaRecepcion;
	@Column(name="ESTADO")	
	...
	/**
	 * @return the idBoletaDepositoChequeDiferido
	 */
	public Long getIdBoletaDepositoChequeDiferido() {
		return idBoletaDepositoChequeDiferido;
	}
	/**
	 * @param idBoletaDepositoChequeDiferido the idBoletaDepositoChequeDiferido to set
	 */
	public void setIdBoletaDepositoChequeDiferido(
			Long idBoletaDepositoChequeDiferido) {
		this.idBoletaDepositoChequeDiferido = idBoletaDepositoChequeDiferido;
	}
	/**
	 ...
	 */
	public Long getIdReciboPreimpreso() {
		return idReciboPreimpreso;
	}
	/**
	 * @param idReciboPreimpreso the idReciboPreimpreso to set
	 */
	public void setIdReciboPreimpreso(Long idReciboPreimpreso) {
		this.idReciboPreimpreso = idReciboPreimpreso;
	}
	/**
	 * @return the nroConstanciaRecepcion
	 */
	public Long getNroConstanciaRecepcion() {
		return nroConstanciaRecepcion;
	}
	/**
	 * @param nroConstanciaRecepcion the nroConstanciaRecepcion to set
	 */
	public void setNroConstanciaRecepcion(Long nroConstanciaRecepcion) {
		this.nroConstanciaRecepcion = nroConstanciaRecepcion;
	}
	/**
	 * @return the estado
	 */
