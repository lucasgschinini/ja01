...
public class VistaSoporteResultadoBusquedaCobroHistorial extends VistaSoporteResultadoBusqueda{
	...
	private String observacionSistSoc;//"(Sociedad/Sistema)"
	...
	/**
	 * @return the observacionSistSoc
	 */
	public String getObservacionSistSoc() {
		return observacionSistSoc;
	}
	/**
	 * @param observacionSistSoc the observacionSistSoc to set
	 */
	public void setObservacionSistSoc(String observacionSistSoc) {
		this.observacionSistSoc = observacionSistSoc;
	}
	/**
