...
@Entity
@Table(name = "SHV_MIG_VALOR_CHEQUE")
public class ShvMigValorCheque extends Modelo {

	private static final long serialVersionUID = 1L;
	
	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SEQ_SHV_MIG_VALOR_CHEQUE")
    @SequenceGenerator(name="SEQ_SHV_MIG_VALOR_CHEQUE", sequenceName="SEQ_SHV_MIG_VALOR_CHEQUE",allocationSize=1)
	@Column(name="ID")
	private Long idValorCheque;
	...
	/**
	 * @return the idValorCheque
	 */
	public Long getIdValorCheque() {
		return idValorCheque;
	}
	/**
	 * @param idValorCheque the idValorCheque to set
	 */
	public void setIdValorCheque(Long idValorCheque) {
		this.idValorCheque = idValorCheque;
	}
	/**
