...
public class ShvCobFacturaUsuario extends ShvCobFactura{
	...
	@Column(name="IMPORTE_APLICADO_FECHA_EMISION")
	private BigDecimal importeAplicadoAFechaEmision;
	...
	/**
	 * @return the importeAplicadoAFechaEmision
	 */
	public BigDecimal getImporteAplicadoAFechaEmision() {
		return importeAplicadoAFechaEmision;
	}

	/**
	 * @param importeAplicadoAFechaEmision the importeAplicadoAFechaEmision to set
	 */
	public void setImporteAplicadoAFechaEmision(BigDecimal importeAplicadoAFechaEmision) {
		this.importeAplicadoAFechaEmision = importeAplicadoAFechaEmision;
	}
