...
public interface IProcesamientoHilosCobrosServicio extends IServicio {

	List<ResultadoBusquedaCantidadHilosEnCurso> obtenerCantidadHilosEnCurso(EstadoProcesamientoHilosEnum estado, TipoImputacionEnum tipoImputacion) throws PersistenciaExcepcion;
