 ...
 * 10/09/2014
 */
public class ResultadoBusquedaInterdepositoSinConciliarMapeador extends MapeadorResultadoBusqueda {
	...
	public DTO map(VistaSoporteResultadoBusqueda vo) throws NegocioExcepcion {
		...
		InterdepositoDto registroAvcSinConciliarDto = new InterdepositoDto();		
		if(vista != null){			
			...
			if(vista.getCodigoOrganismo() != null){
				registroAvcSinConciliarDto.setCodigoOrganismo(vista.getCodigoOrganismo());
			}
