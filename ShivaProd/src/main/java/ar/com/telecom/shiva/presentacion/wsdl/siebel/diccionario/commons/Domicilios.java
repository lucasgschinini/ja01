...
@XmlRootElement(name = "domicilios")
public class Domicilios {

    protected List<Domicilios.Domicilio> domicilio;
     ...
     * {@link Domicilios.Domicilio }
     * 
     * 
     */
    public List<Domicilios.Domicilio> getDomicilio() {
        if (domicilio == null) {
            domicilio = new ArrayList<Domicilios.Domicilio>();
        }
