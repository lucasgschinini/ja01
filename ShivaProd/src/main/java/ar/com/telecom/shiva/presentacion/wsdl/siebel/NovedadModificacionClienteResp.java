...
@XmlType(name = "")
@XmlRootElement(name = "novedadModificacionClienteResp", namespace = "http://www.telecom.com.ar/XMLSchema/bios/cliente/responseMessage")
public class NovedadModificacionClienteResp {
