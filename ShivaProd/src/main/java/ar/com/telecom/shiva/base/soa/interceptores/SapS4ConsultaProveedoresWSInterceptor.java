...
public class SapS4ConsultaProveedoresWSInterceptor implements SOAPHandler<SOAPMessageContext> {
    ...
    private void cargarDatosDummy(SOAPMessageContext smc) {
    	...
    	try {
    	    ...
    	    String idOperacion = ControlXml.buscarElemento("TAX_NO_1", baos.toByteArray());
            ...
            strXML.append("<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap-env:Envelope xmlns:soap-env=\"http://schemas.xmlsoap.org/soap/envelope/\">")
            .append("<soap-env:Header/>")
            .append("<soap-env:Body>")
            .append("<n0:ZFI_SHIVA_VENDOR_FINDResponse xmlns:n0=\"urn:sap-com:document:sap:rfc:functions\">")
            .append("<EXP_VENDOR_DATA>")
            .append("<item>")
            .append("<TAX_NO_1>30709711640</TAX_NO_1>")
            .append("<COMP_CODE>M650</COMP_CODE>")
            .append("<VENDOR>0001005369</VENDOR>")
            .append("<PMNT_BLOCK/>")
            .append("<TEXTL>Autorizado el pago</TEXTL>")
            .append("</item>")
            .append(" </EXP_VENDOR_DATA>")
            .append("<ST_RETURN><TYPE>S</TYPE><NUMBER>000</NUMBER><MESSAGE>Proceso OK</MESSAGE></ST_RETURN><T_RETURN/></n0:ZFI_SHIVA_VENDOR_FINDResponse>")
            		.append("</soap-env:Body>")
            				.append("</soap-env:Envelope>");
            
            
            mensaje = strXML.toString();
//			//8750090.00001
...
//			}
            System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!!SSSSSSSSSSSSSSS4");
