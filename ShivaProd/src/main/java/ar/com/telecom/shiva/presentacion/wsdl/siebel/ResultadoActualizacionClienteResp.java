...
@XmlType(name = "")
@XmlRootElement(name = "resultadoActualizacionClienteResp", namespace = "http://www.telecom.com.ar/XMLSchema/bios/cliente/responseMessage")
public class ResultadoActualizacionClienteResp {
