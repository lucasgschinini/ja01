...
@XmlType(name = "retencionSegSoc", propOrder = {"idValor","importe","saldoDisponible","fechaValor","motivo","operacionAsociada",
						"observaciones","cliente","numeroConstancia","fechaEmision"})
public class ValoresRetencionSeguridadSocial {
