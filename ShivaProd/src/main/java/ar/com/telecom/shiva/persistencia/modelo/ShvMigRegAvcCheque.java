...
@Entity
@Table(name = "SHV_MIG_REGISTRO_AVC_CHEQUE")
public class ShvMigRegAvcCheque extends Modelo {

	private static final long serialVersionUID = 1L;
	
	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SEQ_SHV_MIG_AVC_CHEQUE")
    @SequenceGenerator(name="SEQ_SHV_MIG_AVC_CHEQUE", sequenceName="SEQ_SHV_MIG_AVC_CHEQUE",allocationSize=1)
	@Column(name="ID")
	private Long idRegAvcCheque;
	...
	@Column(name="DATOS_BANCO_CUENTA_CHEQUE")
	private String datosBancoCuentaCheque;
	/**
	 * @return the idRegAvcCheque
	 */
	public Long getIdRegAvcCheque() {
		return idRegAvcCheque;
	}
	/**
	 * @param idRegAvcCheque the idRegAvcCheque to set
	 */
	public void setIdRegAvcCheque(Long idRegAvcCheque) {
		this.idRegAvcCheque = idRegAvcCheque;
	}
	/**
	...
	/**
	 * @return the idRecInstrumento
	 */
	public Long getIdRecInstrumento() {
		return idRecInstrumento;
	}
	/**
	 * @param idRecInstrumento the idRecInstrumento to set
	 */
	...
	/**
	 * @return the estadoAcreditacion
	 */
	public String getEstadoAcreditacion() {
		return estadoAcreditacion;
	}
	/**
	 * @param estadoAcreditacion the estadoAcreditacion to set
	 */
	...
	/**
	 * @return the codigoRechazo
	 */
	public String getCodigoRechazo() {
		return codigoRechazo;
	}
	/**
	 * @param codigoRechazo the codigoRechazo to set
	 */
	public void setCodigoRechazo(String codigoRechazo) {
		this.codigoRechazo = codigoRechazo;
	}
	/**
	 * @return the datosBancoCuentaCheque
	 */
	public String getDatosBancoCuentaCheque() {
		return datosBancoCuentaCheque;
	}
	/**
	 * @param datosBancoCuentaCheque the datosBancoCuentaCheque to set
	 */
	public void setDatosBancoCuentaCheque(String datosBancoCuentaCheque) {
		this.datosBancoCuentaCheque = datosBancoCuentaCheque;
	}	
