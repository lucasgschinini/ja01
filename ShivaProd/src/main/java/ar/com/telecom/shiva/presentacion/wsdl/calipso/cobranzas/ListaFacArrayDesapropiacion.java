...
/**
 * <p>Java class for listaFacArrayDesapropiacion complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="listaFacArrayDesapropiacion">
 *   &lt;complexContent>
...
@XmlType(name = "listaFacArrayDesapropiacion", propOrder = {
    "detalle",
    "detalleCargos"
})
public class ListaFacArrayDesapropiacion {

    @XmlElement(required = true)
    protected List<ListaFacArrayDesapropiacion.Detalle> detalle;
    @XmlElement(required = true)
    protected List<ListaFacArrayDesapropiacion.DetalleCargos> detalleCargos;
     ...
     * {@link ListaFacArrayDesapropiacion.Detalle }
     * 
     * 
     */
    public List<ListaFacArrayDesapropiacion.Detalle> getDetalle() {
        if (detalle == null) {
            detalle = new ArrayList<ListaFacArrayDesapropiacion.Detalle>();
        }
        return this.detalle;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ListaFacArrayDesapropiacion.DetalleCargos }
     * 
     * 
     */
    public List<ListaFacArrayDesapropiacion.DetalleCargos> getDetalleCargos() {
        if (detalleCargos == null) {
            detalleCargos = new ArrayList<ListaFacArrayDesapropiacion.DetalleCargos>();
        }
