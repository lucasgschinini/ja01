...
@XmlType(name = "")
@XmlRootElement(name = "resultadoInactivacionClienteResp", namespace = "http://www.telecom.com.ar/XMLSchema/bios/cliente/responseMessage")
public class ResultadoInactivacionClienteResp {
