...
@XmlType(name = "")
@XmlRootElement(name = "notificarReplicaClienteEnLegadoResp", namespace = "http://www.telecom.com.ar/XMLSchema/bios/cliente/responseMessage")
public class NotificarReplicaClienteEnLegadoResp {
