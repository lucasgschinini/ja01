...
NOMBRE_PROCESO=batch-shiva-procesarArchivosAvcDinamico
...
then
	...
	java -cp ".:${CLASSPATH}" -Djava.io.tmpdir=${TEMP} \
	   ...
	   ar.com.telecom.shiva.batch.springbatch.launcher.ProcesarArchivosAvcDinamicoBatchRunner >>$LOG_ERROR >>$LOG_ARCHIVO 2>>$LOG_ERROR
else
