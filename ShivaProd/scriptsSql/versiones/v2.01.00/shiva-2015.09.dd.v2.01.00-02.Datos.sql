----------------------------------------------------------------------------------------------------------------
-- Actualizaci󮠤e SHV_PARAM_PARAMETRO para SIMULACION en cobros
----------------------------------------------------------------------------------------------------------------
...
insert into SHV_PARAM_TIPO_ORIGEN_CONTABLE values ('014','Apropiación del valor','SPRINT 6');

update SHV_PARAM_TIPO_ORIGEN_CONTABLE set descripcion='Confirmación de aplicación MP sobre reintegro valor SHIVA' where ID_TIPO_ORIGEN_CONTABLE='017';
update SHV_PARAM_TIPO_ORIGEN_CONTABLE set descripcion='Desapropiación del valor' where ID_TIPO_ORIGEN_CONTABLE='018';
update SHV_PARAM_TIPO_ORIGEN_CONTABLE set descripcion='Reversión de aplicación MP sobre reintegro valor' where ID_TIPO_ORIGEN_CONTABLE='019';
commit;
